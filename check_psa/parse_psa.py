...
PRODUCT = [
    ...
    "alternate_height",
    "alternate_depth",
    "alternate_number_wide",
    "alternate_number_high",
    "alternate_number_deep",
    "alternate_total_number",
    "alternate_max_high",
    "loose_width",
    "loose_height",
    "loose_depth",
    ...
    "flag_9",
    "flag_10",
    "minimum_squeeze_factor_x",
    "minimum_squeeze_factor_y",
    "minimum_squeeze_factor_z",
    "maximum_squeeze_factor_x",
    "maximum_squeeze_factor_y",
    "maximum_squeeze_factor_z",
    "fill_pattern",
    "model_filename",
    "brand",
    "subcategory",
...
POSITION = [
    ...
    "peg_span",
    "always_float",
    "primary_position_label_format_name",
    "secondary_position_label_format_name",
    "merchxmin",
    "merchxmax",
    "merchxuprights",
    "merchxcaps",
...
PLANOGRAM = [
    ...
    "floor_tile_width",
    "floor_tile_depth",
    "inventory_model_manual",
    "inventory_model_case_multiple",
    "inventory_model_days_supply",
    "inventory_model_peak",
    "inventory_model_min_units",
    "inventory_model_max_units",
    "case_multiple",
    "days_supply",
    "demand_cycle_length",
    "peak_safety_factor",
    ...
    "allocation_group",
    "allocation_sequence",
    "allocation_target_min",
    "allocation_target_max",
    "can_segment",
    "can_split",
    "pg_status",
    "pg_score_percent",
    ...
    "allocation_merge",
    "is_merged",
    "inventory_model_demand_mean_variance",
    "service_level",
    "pg_results_1",
    "pg_results_2",
    "pg_results_3",
...
FIXTURE = [
    ...
    "peg_gap_x",
    "peg_gap_y",
    "primary_fixture_label_format_name",
    "secondary_fixture_label_format_name",
    "shape_id",
    "bitmap_id",
    "merchxmin",
    "merchxmax",
    ...
    "divider_at_start",
    "divider_at_end",
    "dividers_between_facings",
    "transparency",
    "hide_if_printing",
    "product_association",
    "partid",
    "hide_view_dimensions",
    "gln",
    # "custom_data",
    "can_attach",
    "attached_to_fixture",
